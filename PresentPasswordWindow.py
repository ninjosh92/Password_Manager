...
class PresentPasswordWindow:
    #creates the window object
    #params: url, the username, and the password
    #return: true if successful, flase otherwise
    def __init__(self, passwordToRetrieveKey, my_DB_interface):
        print("Inside present password class")
        self.my_DB_interface = my_DB_interface
        self.open_present_password_window(passwordToRetrieveKey, my_DB_interface)
    ...
    def open_present_password_window(self, passwordToRetrieveKey, my_DB_interface):
